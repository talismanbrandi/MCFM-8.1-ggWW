...
C      call get_MELA_Discr_ppZZ(p,D_MELA)
C      call bookplot(n,tag,'D_PP_BKG(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.05_dp,'lin')
C      n=n+1
C
C      call get_MELA_Discr_ppZZ_CMS(p,D_MELA)
C      call bookplot(n,tag,'D_PP_CMS(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.05_dp,'lin')
C      n=n+1
C      
C      call get_MELA_Discr_ppZZ_BSM(p,D_MELA,0.5_dp,0.5_dp)
C      call bookplot(n,tag,'D_PP_BSM_0.5_0.5(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.05_dp,'lin')
C      n=n+1      
C      
C      call get_MELA_Discr_ppZZ_BSM(p,D_MELA,0.8_dp,0.2_dp)
C      call bookplot(n,tag,'D_PP_BSM_0.8_0.2(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.05_dp,'lin')
C      n=n+1      
C      
C      call get_MELA_Discr_ppZZ_BSM(p,D_MELA,sqrt(10._dp),sqrt(10._dp))
C      call bookplot(n,tag,'D_PP_BSM_sqrt10_sqrt10(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.05_dp,'lin')
C      n=n+1
     ...
     & D_MELA,wt,wt2,0._dp,2._dp,0.1_dp,'lin')
      n=n+1
      
      call get_MELA_Discr_PPZZ_BSM_SM(p,D_MELA,1.5_dp,-0.5_dp)
      call bookplot(n,tag,'D_BSM_o_SM(Spp vs. Bpp)',
     & D_MELA,wt,wt2,0.5_dp,1.5_dp,0.1_dp,'lin')
      n=n+1
...
C      n=n+1
C      
C      call bookplot(n,tag,'D_PP_BSM_0.7_0.3_S(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.1_dp,'lin')
C      n=n+1   
C      
C      call get_MELA_Discr_ggZZ_BSM(p,D_MELA,sqrt(10._dp),sqrt(10._dp))
C      call bookplot(n,tag,'D_PP_BSM_sqrt10_sqrt10(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.25_dp,'lin')
C      n=n+1
C      
C      call bookplot(n,tag,'D_PP_BSM_sqrt10_sqrt10_S(Spp vs. Bpp)',
C     & D_MELA,wt,wt2,0._dp,1._dp,0.1_dp,'lin')
C      n=n+1   
