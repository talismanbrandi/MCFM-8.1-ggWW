      ...
      complex*32 function hjetmass_triangle_pppp_s124_0_mhsq_rat
     &     (i1,i2,i3,i4,za,zb)
      ...
      t15 = t6 * t12
      t16 = t13 + t14 + t15
      if ( real(t16) > 0q0) then; cg = 1q0; else; cg = -1q0; end if
      t16 = cg * sqrt(t16 ** 2) + t13 + t14 + t15
      t17 = zb(i2, i1)
      t18 = zb(i4, i2)
      t19 = t5 * t17
      t20 = t2 * t10
     ...
     #* (t27 * t44 * t2 - t5)) + t35 * (t87 * t41 * t5 + t88 * t39))
      ...
      hjetmass_triangle_pppp_s124_0_mhsq_rat = ret/32q0/(0,1q0)
      return
