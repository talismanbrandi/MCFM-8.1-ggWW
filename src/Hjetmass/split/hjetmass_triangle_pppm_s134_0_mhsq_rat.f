      ...
      complex*32 function hjetmass_triangle_pppm_s134_0_mhsq_rat
     &     (i1,i2,i3,i4,za,zb)
      ...
      t13 = t9 * t10
      t14 = t12 + t13 + t11
      if ( real(t14) > 0q0) then; cg = 1q0; else; cg = -1q0; end if
      t12 = cg * sqrt(t14 ** 2) + t11 + t12 + t13
      t14 = zb(i4, i1)
      t15 = zb(i4, i3)
      t16 = za(i1, i3)
      t17 = t16 * t2
     ...
     # 2 * t6 * t12 * t14 * t15 * t43 * (-t3 * t5 + t33)
      ...
      hjetmass_triangle_pppm_s134_0_mhsq_rat = ret/32q0/(0,1q0)
      return
