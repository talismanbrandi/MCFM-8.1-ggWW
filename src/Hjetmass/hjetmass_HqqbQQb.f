      complex*32 function hjetmass_qqbqqb_bubble_pmpm_mhsq
     &  (i1,i2,i3,i4,za,zb)
      ...
      hjetmass_qqbqqb_bubble_pmpm_mhsq =
     &   - hjetmass_qqbqqb_bubble_pmpm_s12(i1,i2,i3,i4,za,zb)
     &   - hjetmass_qqbqqb_bubble_pmpm_s34(i1,i2,i3,i4,za,zb)
      return
      
      end function

      complex*32 function hjetmass_qqbqqb_bubble_pmpm_s12
     &  (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
     ...
     # * t7 * t27 - 20 * t120 + t11) * t26 * t19 * t20 * t25
      ...
      hjetmass_qqbqqb_bubble_pmpm_s12 =  ret/16q0*(0q0,1q0)
      return
      
      end function

      complex*32 function hjetmass_qqbqqb_bubble_pmpm_s34
     &  (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
     ...
     #t21 * t23
      ...
      hjetmass_qqbqqb_bubble_pmpm_s34 =  ret/16q0*(0q0,1q0)
      return
      
      end function

      complex*32 function
     & hjetmass_qqbQQB_triangle_pmpm_s34_mhsq_s12
     & (i1,i2,i3,i4,za,zb,mt)
      ...
      t16 = t9 * t12
      t17 = t15 + t16 + t13 + t14
      t17 = -0.4q1 * t4 * t5 * t6 * t7 + t17 ** 2
      t13 = cg * sqrt(t17) + t13 + t14 + t15 + t16
      t14 = 0.2q1 * t4 * t6
      t15 = t14 + t13
      t16 = 0.1q1 / 0.2q1
     ...
     #* t11 + t12 * t3)) - t1 * t2 * t30)) - 0.32q2 * t32 * t16 - 0.64q2
     # * t31 * mt ** 2 * t13 * t16 - 0.4q1 * t14 * (t5 * t7 * t15 ** 2 *
     # t23 * t24 * t20 * t28 + t4 * t6 * t17 ** 2 * t19 * t18 * t22 * t2
     #9) - 0.2q1 * t32 * t23 * t19

      hjetmass_qqbQQB_triangle_pmpm_s34_mhsq_s12 = ret/16q0/(0,1q0)
      return

      end function
     &
      complex*32 function
     & hjetmass_qqbQQb_triangle_pmpm_s34_mhsq_s12_rat
     & (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
      ...
      t10 = zb(i2, i1)
      t11 = zb(i4, i3)
      t7 = -0.4q1 * t8 * t9 * t10 * t11 + t7 ** 2
      t3 = cg * sqrt(t7) + t3 + t4 + t5 + t6
      t4 = t8 * t9
      ...
      t9 = 0.1q1 / t9
      t7 = 0.1q1 / t7 ** 2
      ret = (-0.32q2 * t4 * t6 * t2 * t10 * t1 * t11 + 0.16q2 * t4 * t3 
     #* t10 * t11 * t5 + 0.4q1 * t3 * t6 * t5) * t8 * t9 * t13 * t12 * t
     #7
    
      hjetmass_qqbQQb_triangle_pmpm_s34_mhsq_s12_rat = ret/16q0/(0,1q0)
      return

      end function

      complex*32 function
     & hjetmass_qqbQQB_triangle_pmmp_s34_mhsq_s12
     & (i1,i2,i3,i4,za,zb,mt)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
     ...
     #t8 - t10 * t9)) - t30 * t11 * t12)) - 0.32q2 * t32 * t16 - 0.64q2 
     #* t31 * mt ** 2 * t13 * t16 - 0.4q1 * t14 * (t5 * t7 * t15 ** 2 * 
     #t22 * t19 * t24 * t28 + t4 * t6 * t17 ** 2 * t23 * t18 * t29 * t20
     #) - 0.2q1 * t32 * t23 * t19

      hjetmass_qqbQQB_triangle_pmmp_s34_mhsq_s12 = ret/16q0/(0,1q0)
      return

      end function
     &
      complex*32 function
     & hjetmass_qqbQQb_triangle_pmmp_s34_mhsq_s12_rat
     & (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
      ...
      t13 = 0.1q1 / t10
      t7 = 0.1q1 / t7 ** 2
      ret = (-0.32q2 * t4 * t6 * t1 * t10 * t2 * t11 - 0.16q2 * t4 * t3 
     #* t10 * t11 * t5 - 0.4q1 * t3 * t6 * t5) * t8 * t9 * t13 * t12 * t
     #7

      hjetmass_qqbQQb_triangle_pmmp_s34_mhsq_s12_rat = ret/16q0/(0,1q0)
      return

      end function
      complex*32 function hjetmass_qqbqqb_bubble_pmmp_s34
     &  (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
     ...
     # t16 * t17
      ...
      hjetmass_qqbqqb_bubble_pmmp_s34 =  ret/16q0*(0q0,1q0)
      return
      
      end function

      complex*32 function hjetmass_qqbqqb_bubble_pmmp_s12
     &  (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
     ...
     #1024 * t13 + 5376 * t44 + 256 * t11) * t25 * t12 * t16 * t20
      ...
      hjetmass_qqbqqb_bubble_pmmp_s12 =  ret/16q0*(0q0,1q0)
      return
      
      end function

      complex*32 function hjetmass_qqbqqb_bubble_pmmp_mhsq
     &  (i1,i2,i3,i4,za,zb)
      implicit complex*32 (t)
      integer i1,i2,i3,i4
          include 'types.f'
      ...
      hjetmass_qqbqqb_bubble_pmmp_mhsq =
     &   - hjetmass_qqbqqb_bubble_pmmp_s12(i1,i2,i3,i4,za,zb)
     &   - hjetmass_qqbqqb_bubble_pmmp_s34(i1,i2,i3,i4,za,zb)
      return
