     ...
     .2._dp*za(j1,j2)*za(j3,j4)*zb(j1,j3))*zb(j4,j6))/
     .((s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*s(j5,
     .j6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*za(j1,j4)*
     .(-(za(j1,j4)*zb(j1,j3))-za(j2,j4)*zb(j2,j3)))-
     .(za(j3,j5)*((-s(j1,j2)-s(j3,j4)+s(j5,j6))*zb(j1,j3)+
     .2._dp*za(j2,j4)*zb(j1,j2)*zb(j3,j4))*zb(j4,j6))/
     .((s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*s(j5,
     .j6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*zb(j2,j3)*
     .(-(za(j1,j4)*zb(j1,j3))-za(j2,j4)*zb(j2,j3)))
     ...
     .2._dp*za(j1,j2)*za(j3,j4)*zb(j2,j4))))/za(j3,j4))+
     .(zb(j4,j6)*(-(za(j2,j5)*
     .((-s(j1,j2)-s(j3,j4)+s(j5,j6))*zb(j2,j4)+
     .2._dp*za(j1,j3)*zb(j1,j2)*zb(j3,j4)))-
     ...
     .(2._dp*(s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*s
     .(j5,j6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*za(j3,j4)*zb(j2,j3)*
     .(-(za(j1,j4)*zb(j1,j3))-za(j2,j4)*zb(j2,j3)))+
     ...
     .2._dp*za(j2,j4)*zb(j1,j2)*zb(j3,j4)))/
     .(s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*s(j5,j
     .6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)**2+
     ...
     .zb(j1,j3)*zb(j4,j6)+
     .2._dp*za(j2,j3)*zb(j1,j2)*
     .((s(j1,j2)-s(j3,j4)-s(j5,j6))*zb(j3,j6)-
     .2._dp*za(j4,j5)*zb(j3,j4)*zb(j5,j6))))/zb(j5,j6)+
     ...
     .(za(j3,j4)*zb(j1,j3)*
     .(-(za(j1,j5)*zb(j1,j6))-za(j2,j5)*zb(j2,j6))-
     .3._dp*za(j2,j4)*za(j3,j5)*zb(j1,j2)*zb(j3,j6))-
     .za(j2,j3)*zb(j1,j2)*
     ...
     .(-(za(j1,j5)*zb(j1,j4))-za(j2,j5)*zb(j2,j4)))-
     .3._dp*(-s(j1,j2)+s(j3,j4)-s(j5,j6))*za(j2,j4)*za(j3,j5)*
     .zb(j3,j4)-za(j2,j4)*za(j3,j4)*
     .(-(za(j1,j5)*zb(j1,j4))-za(j2,j5)*zb(j2,j4))*zb(j3,j4)-
     .2._dp*za(j1,j2)*zb(j1,j4)*
     .((s(j1,j2)-s(j3,j4)-s(j5,j6))*za(j4,j5)-
     .2._dp*za(j3,j4)*za(j5,j6)*zb(j3,j6))))/za(j5,j6)-
     ...
     .2._dp*za(j4,j5)*zb(j3,j4)*zb(j5,j6))-
     .(za(j1,j2)*zb(j1,j3)*
     ...
     .(-(za(j1,j5)*zb(j1,j6))-za(j2,j5)*zb(j2,j6))+
     .4._dp*(-(za(j1,j2)*za(j3,j5)*zb(j1,j4)*zb(j2,j6))+
     ...
     .(-(za(j1,j3)*zb(j2,j3))-za(j1,j4)*zb(j2,j4))+
     .4._dp*(-(za(j1,j2)*za(j3,j5)*zb(j1,j6)*zb(j2,j4))+
