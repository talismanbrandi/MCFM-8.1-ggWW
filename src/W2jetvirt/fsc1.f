     ...
     .s(j5,j6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*za(j3,j4)*za(j5,j6)*zb(j1,j2)*
     ...
     .(2._dp*(s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*
     .s(j5,j6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*za(j3,j4)*zb(j1,j2)*
     ...
     .2._dp*za(j3,j4)*za(j5,j6)*zb(j4,j6)))/
     ...
     .2._dp*s(j1,j2)*s(j5,j6)-2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*zb(j1,j2)
     .*
     .zb(j5,j6))))/
     .((-(za(j1,j3)*zb(j1,j4))-za(j2,j3)*zb(j2,j4))*
     .(za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4)))
     ...
     .2._dp*s(j1,j2)*s(j5,j6)-2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)**2*
     .(-(za(j1,j3)*zb(j1,j4))-za(j2,j3)*zb(j2,j4)))+
     ...
     .2._dp*za(j1,j5)*zb(j1,j2)*zb(j5,j6)))/
     .(s(j1,j2)**2-2._dp*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2._dp*s(j1,j2)*s(j5,j
     .6)-
     .2._dp*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)**2-
     .((-(za(j2,j3)*zb(j1,j3))-za(j2,j4)*zb(j1,j4))*
