...
c --- BEGIN MODIFICATION for ggZZ -- AP        
        call gg_hzz_tb(p,msq,.false.,zip,zip) ! The last two numbers do not matter since third argument is set to .false.
...
c --- BEGIN MODIFICATION for ggZZ -- AP        
        call gg_zz_int(p,msq,.false.,zip,zip,zip,zip) ! The last four numbers do not matter since fifth last argument is set to .false.
      elseif (kcase==kHZZHpi) then
        call gg_zz_Hpi(p,msq,.false.,zip,zip,zip,zip) ! The last four numbers do not matter since fifth last argument is set to .false.
      elseif (kcase==kggZZ4l) then
        call gg_zz_all(p,msq,.false.,zip,zip,zip,zip) ! The last four numbers do not matter since fifth last argument is set to .false.
      elseif (kcase==kggZZbx) then
        msq(:,:)=0._dp
        call gg_ZZ(p,msq(0,0),.false.,zip,zip,zip,zip) ! The last four numbers do not matter since fifth last argument is set to .false.
c --- END MODIFICATION for ggZZ -- AP        
